 ...
 * @author Abi
 */
public class VentanaInsertarB extends javax.swing.JFrame {

    public VentanaInsertarB() {
        initComponents();
    ...
    private void initComponents() {
        ...
        botonInsertar.setBounds(360, 60, 90, 23);
        EventoInsertar elEventoInsertar = new EventoInsertar();
        botonInsertar.addActionListener(elEventoInsertar);
        ...
        scrollTablaUsuarios.setBounds(50, 130, 640, 290);

        setSize(new java.awt.Dimension(742, 491));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaInsertarB().setVisible(true);
            }
        });
    }
    ...
    /* Clase interna */
    private class EventoInsertar implements ActionListener {
