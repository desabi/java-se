 ...
 * @author Abi
 */
public class VentanaActualizarA extends javax.swing.JFrame implements MouseListener, ActionListener {

    /**
     * Creates new form VentanaActualizar
     */
    public VentanaActualizarA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaActualizarA().setVisible(true);
            }
        });
    }
